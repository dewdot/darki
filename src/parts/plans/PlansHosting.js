...
export default function PlansHosting() {
  return (
    <section className="section section-pricing-hosting">
      <h2 className="section-title">Simple and Flexible Hosting Plans</h2>
      <div className="section-small">
        <p className="font-size-medium width-5">Simple, transparent hosting plans designed to fit personal websites, businesses, and growing online projects.</p>
      </div>
